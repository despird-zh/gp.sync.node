...
//		// MessageBufferPacker is an optimized version of MessagePacker for packing data
//		// into a byte array
...
//		packer.close();
//
//		// Read packed data from a file. No need exists to wrap the file stream with an
//		// buffer
...
//		MessageUnpacker unpacker = new UnpackerConfig().withStringDecoderBufferSize(16 * 1024) // If your data contains
//																								// many large strings
//																								// (the default is 8k)
